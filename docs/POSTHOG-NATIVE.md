...
| `main_recruiting_content_card_click` | 메인 채널 콘텐츠 카드                              | `category`, `content_type`                        |
| `footer_social_icon_click`           | Footer 소셜 링크                                   | `content_type`                                    |
| `recruiting_page_viewed`             | `/recruiting/` 라우트 진입                         | 없음                                              |
| `recruiting_jd_card_click`           | 모집 부서 카드                                     | `team_name`                                       |
| `jd_page_viewed`                     | `/recruiting/{department}` 라우트 진입             | `team_name`                                       |
| `jd_apply_click`                     | 활성화된 데스크톱·모바일 외부 지원 폼 링크         | `team_name`                                       |
| `jd_to_faq_click`                    | JD의 FAQ 바로가기                                  | `team_name`                                       |
| `jd_external_content_card_click`     | JD의 미디엄·영상 링크                              | `page_type`, `content_type`, `team_name`          |
| `jd_contact_click`                   | JD의 문의 링크                                     | `team_name`                                       |
| `faq_toggle_click`                   | 리크루팅·JD FAQ 항목 열기 또는 닫기                | `faq_key`, `page_type`, 선택적 `team_name`        |
| `main_scroll_depth_reached`          | 메인 50·70·90% 최초 통과                           | `scroll_percent`                                  |
| `recruiting_scroll_depth_reached`    | 리크루팅 50·70·90% 최초 통과                       | `scroll_percent`                                  |
| `jd_scroll_depth_reached`            | JD 50·70·90% 최초 통과                             | `scroll_percent`, `team_name`                     |
